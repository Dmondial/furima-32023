...
ActiveRecord::Schema.define(version: 2020_12_02_033041) do
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "send_source_id", null: false
  ...
  create_table "order_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_purchase_id"], name: "index_order_addresses_on_item_purchase_id"
  end
  ...
  add_foreign_key "order_addresses", "item_purchases"
end
